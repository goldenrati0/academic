public class LinkedListTester {
	...
	public static void main(String[] args) {
		...
		LinkedList h1 = new LinkedList(a1); // Creates a linked list using the
		...
		System.out.println("\n/////  Test 03  /////");
		// returns the reference of the Node at the given index. For invalid idx
		// return null.
		Node myNode = h1.nodeAt(1);
		System.out.println(myNode.element); // This should print: 20. In case of
											// invalid index This will
		...
		// return null.
		Object val = h1.get(2);
		System.out.println(val); // This should print: 30. In case of invalid
									// index This will print null.
		...
		System.out.println(index); // This should print: 3. In case of element
									// that
		// doesn't exists in the list this will print -1.

		System.out.println("\n/////  Test 07  /////");
		// returns true if the element exists in the List, return false
		// otherwise.
		...
		LinkedList h2 = new LinkedList(a2); // uses the first constructor:
											// LinkedList(Object [] a)
		h2.printList(); // This should print: 10,20,30,40,50,60,70.
		// Makes a duplicate copy of the given List. Returns the head reference
		// of the duplicate list.
		Node copyH = h2.copyList(); // Head node reference of the duplicate list
		LinkedList h3 = new LinkedList(copyH); // uses the second constructor:
												// LinkedList(Node h)
		h3.printList(); // This should print: 10,20,30,40,50,60,70.

		System.out.println("\n/////  Test 09  /////");
		Object[] a4 = { 10, 20, 30, 40, 50 };
		LinkedList h4 = new LinkedList(a4); // uses the first constructor:
											// LinkedList(Object [] a)
		h4.printList(); // This should print: 10,20,30,40,50.
		// Makes a reversed copy of the given List. Returns the head reference
		// of the reversed list.
		Node revH = h4.reverseList(); // Head node reference of the reversed
										// list
		LinkedList h5 = new LinkedList(revH); // uses the second constructor:
												// LinkedList(Node h)
		h5.printList(); // This should print: 50,40,30,20,10.

		System.out.println("\n/////  Test 10  /////");
		Object[] a6 = { 10, 20, 30, 40 };
		LinkedList h6 = new LinkedList(a6); // uses the first constructor:
											// LinkedList(Object [] a)
		...
		LinkedList h7 = new LinkedList(a7); // uses the first constructor:
											// LinkedList(Object [] a)
		 ...
		 */
		System.out.println("Removed element: " + h7.remove(0)); // This should
																// print:
																// Removed
																// element: 10
		h7.printList(); // This should print: 20,30,40,50,60,70.
		System.out.println("Removed element: " + h7.remove(3)); // This should
																// print:
																// Removed
																// element: 50
		h7.printList(); // This should print: 20,30,40,60,70.
		System.out.println("Removed element: " + h7.remove(4)); // This should
																// print:
																// Removed
																// element: 70
		...
		LinkedList h8 = new LinkedList(a8); // uses the first constructor:
											// LinkedList(Object [] a)
		...
		LinkedList h9 = new LinkedList(a9); // uses the first constructor:
											// LinkedList(Object [] a)
